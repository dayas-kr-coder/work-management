        ...
        <div class="border-b border-gray-900/10 pb-12">
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-2 sm:col-start-1">
              ...
              <div class="mt-2">
                <input value="<?= $work['labour'] ?? '' ?>" type="number" name="labour" id="labour" autocomplete="labour" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-2">
                <input value="<?= $work['food'] ?? '' ?>" type="number" name="food" id="food" autocomplete="food" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-2">
                <input value="<?= $work['taxi'] ?? '' ?>" type="number" name="taxi" id="taxi" autocomplete="taxi" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-2">
                <input value="<?= ($_POST['phone'] ?? '') ?? '' ?>" id="phone" name="phone" type="number" autocomplete="phone" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
